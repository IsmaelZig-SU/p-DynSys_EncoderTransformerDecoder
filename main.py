...
if __name__ == "__main__":
    ...
    parser.add_argument('--nbr_ext_var',           type = int, default = 1,        help = "Number of external variables (Beta, Re, ...)")
    ...
    parser.add_argument('--beta_VAE', type = float, default = 2e-4, help = "regularization beta term for KLD in VAE")
    ...
    #Transfo Params ARGS
    parser.add_argument('--seq_len',          type = int,   default=9,     help = "length of the sequence for memory term")
    ...
    parser.add_argument('--data_dir',        type = str, default = "Data/2DCylinder/processed_data/npyfiles/train.npy", help = "Directory for the Data")
